...
class Block(pg.sprite.Sprite): #o bloco do tetrominó
    ...
    def rotate(self, pivot_pos):#rotação dos blocos
    ...
    def is_collide(self, pos): #verifica se o bloco está em colisão ou não
...
class Tetromino:#o tetrominó completo, o formato que escolhi
    ...
    def rotate(self):#rotação da peça inteira
    ...
    def is_collide(self, block_positions): #se o bloco inteiro está colidindo
        return any(map(Block.is_collide, self.blocks, block_positions))

    def move(self, direction): #mover com os ponteiros do teclado
        move_direction = MOVE_DIRECTIONS[direction]
        new_block_positions = [block.pos + move_direction for block in self.blocks]
        is_collide = self.is_collide(new_block_positions)

        if not is_collide: #caso o tetrominó não esteja colidindo
