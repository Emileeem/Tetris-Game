...
class Text: #toda a informação para formar os textos na tela
    ...
    def draw(self):#cores das letras e letras
        self.font.render_to(self.app.screen, (WIN_W * 0.595, WIN_H * 0.02),
                            text='TETRIS', fgcolor='purple',
                            size=TILE_SIZE * 1.65)
...
class Tetris: #o tetris jogo e suas informações, não os blocos
    def __init__(self, app):
        self.app = app
    ...
    def check_full_lines(self): #checkando se está a pontuação
        row = FIELD_H - 1
    ...
    def is_game_over(self): #verifica se o jogador perdeu
